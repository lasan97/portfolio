package com.portfolio.backend.domain.dashboard.entity;
...
public class Dashboard {
    ...
    @ElementCollection
    @CollectionTable(name = "external_links", joinColumns = @JoinColumn(name = "dashboard_id"))
    ...
    @Builder
    public Dashboard(String title, String content, List<ExternalLink> externalLinks, User createdBy, LocalDateTime createdAt) {
