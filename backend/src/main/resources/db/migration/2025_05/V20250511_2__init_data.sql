...
VALUES
    (1, 10, 0, NOW(), NOW()),  -- 프리미엄 노트북: 10개
    (2, 15, 0, NOW(), NOW()),  -- 인체공학 사무용 의자: 15개
    (3, 30, 0, NOW(), NOW()),  -- 무선 이어버드: 30개
    (4, 20, 0, NOW(), NOW()),  -- 스마트 워치: 20개
    (5, 0, 0, NOW(), NOW()),   -- 블루투스 스피커: 0개 (품절)
    (6, 5, 0, NOW(), NOW()),   -- 원목 식탁: 5개
    (7, 12, 0, NOW(), NOW()),  -- 태블릿 PC: 12개
    (8, 25, 0, NOW(), NOW()),  -- 다용도 선반: 25개
    (9, 0, 0, NOW(), NOW()),   -- 로봇 청소기: 0개 (품절)
    (10, 18, 0, NOW(), NOW()); -- 게이밍 키보드: 18개
