...
class ProductControllerTest extends ControllerTest {
    ...
    class AdjustStock {
        ...
        @SneakyThrows
        ResultActions adjustStock(Long productId, ProductServiceRequest.AdjustStock request) {
            return mockMvc.perform(patch("/api/products/{productId}/stock", productId)
                    .content(objectMapper.writeValueAsString(request))
                    .contentType(MediaType.APPLICATION_JSON));
        }
        ...
        void shouldAdjustStockWithUserRole(int quantity, String reason, String description) throws Exception {
            ...
            assertEquals(quantity, product.getStock().getQuantity(), "Product stock should be updated");
        }
